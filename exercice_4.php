    ...
    <body>
        ...
        <div>
            <p><?php
                ...
                $booleanT = true;
                $booleanF = false;
                echo 'Variable de type string : ' . $string . '<br /> Variable de type int : ' . $int . '<br /> Variable de type float : ' . $float . '<br /> Variable de type booléan (true) : ' . $booleanT . '<br /> Variable de type booléan (false) : ' . $booleanF;
            ?></p>
        </div>
    </body>
</html>
